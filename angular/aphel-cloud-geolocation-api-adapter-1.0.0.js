...
app.factory("$geolocationAPI", function ($http, $q) {
    ...
    var send = function (request, progressChanged) {
        ...
        xhr.open("POST", "https://geolocationapi.aphel.com.tr/");
    ...
    return {
        ...
        updateMemberGeolocation: function (latitude, longitude, progressChanged) {
            ...
            var request = {
                ...
                action: "updateMemberGeolocation",
                params: {
